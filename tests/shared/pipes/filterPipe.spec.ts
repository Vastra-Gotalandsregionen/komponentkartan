import { FilterPipe } from "../../../app/shared/pipes/filterPipe";
    ...
    describe("When filtering on all string properties of an object", () => {
        describe("When filter is undefined", () => {
            it("all objects are returned", () => {
                let filteredResults = filterPipe.transform([{ name: "Anna" }, { name: "Anna-Karin" }, { name: "Bob" }], undefined);
        ...
        describe("When filter is empty string", () => {
            it("all objects are returned", () => {
                let filteredResults = filterPipe.transform([{ name: "Anna" }, { name: "Anna-Karin" }, { name: "Bob" }], "");
        ...
        describe("When filter mathches nothing", () => {
            it("no objects are returned", () => {
                let filteredResults = filterPipe.transform([{ name: "Anna" }, { name: "Anna-Karin" }, { name: "Bob" }], "adfhksjdhfkjsdbfkjsd");
        ...
        describe("When object has one property", () => {
            describe("and filter matches property", () => {
                it("matching objects are returned", () => {
                    let filteredResults = filterPipe.transform([{ name: "Anna" }, { name: "Anna-Karin" }, { name: "Bob" }], "Anna");
        ...
        describe("When object has two properties", () => {
            describe("and filter matches one property", () => {
                it("matching objects are returned", () => {
                    let filteredResults = filterPipe.transform([{ name: "Anna", lastName: "Johansson" }, { name: "Anna-Karin", lastName: "Svensson" }, { name: "Bob", lastName: "Saget" }], "son");
            ...
            describe("and filter matches two properties", () => {
                it("matching objects are returned", () => {
                    let filteredResults = filterPipe.transform([{ name: "Anna", lastName: "Johansson" }, { name: "Anna-Karin", lastName: "Svensson" }, { name: "Johan", lastName: "Larsson" }], "Johan");
        ...
        describe("When object has properties of non-string types", () => {
            describe("and filter matches one property", () => {
                it("matching objects are returned", () => {
                    let filteredResults = filterPipe.transform([
