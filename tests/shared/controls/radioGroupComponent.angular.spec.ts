...
import { RadioGroupComponent } from "../../../app/shared/controls/radioGroup/radioGroup.component";
import { ISelectableItem } from "../../../app/shared/models/selectableItem.model";
...
describe("SaveCancelComponent", () => {
    ...
    describe("When initialized with options", () => {
        var selectedChangedSpy: jasmine.Spy;
        beforeEach(() => {
        ...
        it("options are displayed", () => {
            let visibleOptions = rootElement.queryAll(By.css(".radio-button"));
        ...
        it("only the first option is selected", () => {
            let selectedOptions = rootElement.queryAll(By.css(".radio-button--checked"));
        ...
        describe("and an option is clicked", () => {
            beforeEach(() => {
                ...
                var optionToSelect = rootElement.queryAll(By.css(".radio-button")).filter(x => x.properties["title"] == "Caroline Bornsjö")[0];
    ...
    describe("When initialized with a disabled option", () => {
        ...
        it("the disabled option is displayed as disabled", () => {
            let disabledOptions = rootElement.queryAll(By.css(".radio-button--disabled"));
        ...
        describe("and the disabled option is clicked", () => {
            beforeEach(() => {
                var optionToSelect = rootElement.queryAll(By.css(".radio-button")).filter(x => x.properties["title"] == "Per Åkerberg")[0];
                optionToSelect.triggerEventHandler("click", null);
                fixture.detectChanges();
            });
