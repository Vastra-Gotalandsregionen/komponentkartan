...
// import { BrowserDetector } from "../../app/shared/browserDetector";
...
//                                 let visibleMenuItems = menuComponent.menuItems.filter(menuItem => menuItem.visible);
...
//                                 let visibleMenuItems = menuComponent.menuItems.filter(x => x.visible);
//                                 let favouriteMenuItems = menuComponent.menuItems.filter(x => x.favourite);
...
//         var menuItem = { title: "menu" } as IMenuItem;
...
//         var virtualFavouriteMenuItem: IMenuItem;
//         beforeEach(() => {
//             menuComponent = new MenuComponent(null);
...
//             let favouriteMenuItem2 = { title: "Favorit 2", url: "/två", favourite: true, visible: true } as IMenuItem;
//             let favouriteMenuItem3 = { title: "Favorit 3", url: "/tre", favourite: true, visible: true } as IMenuItem;
