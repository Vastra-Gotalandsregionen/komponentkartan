...
var FakeBComponent = (function () {
    function FakeBComponent() {
        this.sortDirections = list_column_header_component_1.SortDirection;
    }
    return FakeBComponent;
}());
FakeBComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        selector: 'vgr-fake-b',
...
exports.FakeBComponent = FakeBComponent;
//# sourceMappingURL=fake-b.component.js.map