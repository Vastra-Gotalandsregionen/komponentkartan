...
var DatepickerComponent = DatepickerComponent_1 = (function (_super) {
    ...
    DatepickerComponent.prototype.onLeave = function () {
        this.validate();
    };
    ...
    // UI functions
    DatepickerComponent.prototype.displayDatePicker = function () {
        if (this.disabled || this.readonly) {
            return;
        }
    ...
    DatepickerComponent.prototype.onPreviousMonth = function () {
    ...
    DatepickerComponent.prototype.onSelectedDate = function (currentYearMonthIndex, weekIndex, dayIndex) {
...
], DatepickerComponent.prototype, "onOutsideClick", null);
