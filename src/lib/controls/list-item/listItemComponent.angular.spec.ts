...
//       fixture.componentInstance.listItemHeader = <ListItemHeaderComponent>fixture.debugElement.query(By.directive(ListItemHeaderComponent)).componentInstance; // First element in list-item which is list-item-header;
//       fixture.componentInstance.listContent = <ListItemContentComponent>fixture.debugElement.query(By.directive(ListItemContentComponent)).componentInstance;  // Second element in list-item which is list-item-content;
