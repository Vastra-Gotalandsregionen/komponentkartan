...
import { DebugElement, RootRenderer, ElementRef, Component } from '@angular/core';
...
describe('ListItemComponent', () => {
    ...
    describe('[ListItemComponent', () => {
        ...
        describe('When listitem is focused', () => {
            beforeEach(() => {
            ...
            describe('and Enter is pressed', () => {
                var listItemHeader: DebugElement[];
                beforeEach(() => {
...
//     }
// };
// let hero = new ListItemHeaderComponent(new MockElementRef, rootRendererMock);
// selectedHero: ListItemHeaderComponent;
