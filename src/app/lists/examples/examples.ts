...
typeScriptPaginationListMarkup = `import { Component, OnInit } from '@angular/core';
import {
  SortDirection,  // Enum för vilket håll sorteringen skall ske.
  SortChangedArgs // Args när sorteringordningen ändras.
} from 'vgr-komponentkartan/';
...
htmltPaginationListMarkup = ` <vgr-list [pages]="pageCount" (pageChanged)="onPageChanged($event)">
<vgr-list-header>
  <vgr-list-column-header width="5">Förnamn</vgr-list-column-header>
  <vgr-list-column-header width="5">Efternamn</vgr-list-column-header>
  <vgr-list-column-header width="5">Yrke</vgr-list-column-header>
  <vgr-list-column-header [align]="'right'" [width]="5">Inkomst</vgr-list-column-header>
</vgr-list-header>
<vgr-list-item *ngFor="let row of peopleRowsSimpleList">
  <vgr-list-item-header>
    <vgr-list-column width="5">{{row.firstName}}</vgr-list-column>
