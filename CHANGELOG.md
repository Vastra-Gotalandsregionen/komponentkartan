...
- Added component vgr-title-value-layout, replaces the divs with classs title-value-layout
- Changes in data models used when implementing radio groups and dropdown components
